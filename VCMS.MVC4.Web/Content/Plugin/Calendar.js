...
function getSelectedMonth(mm, yy) {
    var content_id = '#calendar';
    currentMonth = mm;
    currentYear = yy;
    $(content_id).html('');
    $(content_id).html(printMonth(currentMonth, currentYear));
...
function getPrevMonthLink(mm, yy) {
    ...
    return '<a onclick="getSelectedMonth(' + mm1 + ',' + yy1 + ');">&lt;</a>';
}
...
function getPrevYearLink(mm, yy) {
    ...
    return '<a onclick="getSelectedMonth(' + mm + ',' + (yy - 1) + ');">&lt;&lt;</a>';
}
