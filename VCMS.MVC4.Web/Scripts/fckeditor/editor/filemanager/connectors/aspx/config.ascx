...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		UserFilesPath = "/UserUpload/FCKEditor/";
		...
		//UserFilesAbsolutePath = Server.MapPath("~/UserUpload/FCKEditor/");

        //this.UserFilesPath = AppContext.urlCKEditor;
        //this.UserFilesAbsolutePath = AppContext.pathCKEditor;
