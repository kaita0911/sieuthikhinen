...
namespace BalsamicSolutions.Extensions
{
    ...
    ///TODO: 
    ///      Can the "Contains" clause be Fluently composable ?
    ///      Can we get access to the DbContext without passing it in and without resorting to Private member reflection?
